...
import { AddServiceModal } from "@/pages/manage-store/components/add-service-modal";
...
import { userAutoGenerateAlisas } from "@/hooks/useAutoGenerateAlisas";
  ...
  const handleAddService = async (data: {
    ...
    try {
      ...
      const addData: AddServiceRequest = {
        ...
        service_alias: data.service_alias || userAutoGenerateAlisas(data.service_name),
      };
  ...
  const handleUpdate = async (data: {
    ...
    try {
      ...
      const updateData: UpdateServiceRequest = {
        service_name: data.service_name,
        service_description: data.service_description,
        service_image: data.image ? await convertToBase64(data.image) : selectedService.service_image_url,
      };
